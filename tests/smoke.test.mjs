...
describe("WPX smoke test", () => {
  ...
  it("implements Phase 1-3 DOM actions, search, import, and export contracts", () => {
    ...
    assert.ok(readText("lib/wpx/dom/exporters/next.ts").includes("createNextScaffoldZip"), "missing Next scaffold exporter");
    assert.ok(readText("lib/wpx/dom/production.ts").includes("createProductionReport"), "missing production report engine");
