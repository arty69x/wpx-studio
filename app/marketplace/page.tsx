...
export default function MarketplacePage() {
  ...
  return (
    <main className="min-h-screen bg-[#09090B] text-white">
      <nav className="sticky top-0 z-40 border-b border-white/10 bg-[#09090B]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          <Link href="/" className="font-semibold tracking-tight">WPX Studio</Link>
          <span className="text-sm text-zinc-400">{marketplaceItems.length} local components</span>
        </div>
      </nav>

      <section className="mx-auto max-w-7xl px-4 py-10">
        <div className="mb-8 rounded-[32px] border border-white/10 bg-[#111214] p-6 shadow-2xl shadow-black/20">
          <p className="text-sm uppercase tracking-[0.25em] text-[#45D6FF]">Component marketplace</p>
          ...
          <div className="mt-6 flex flex-col gap-3 md:flex-row">
            <input
              ...
              className="min-h-12 flex-1 rounded-2xl border border-white/10 bg-black/30 px-4 text-white outline-none transition placeholder:text-zinc-600 focus:ring-2 focus:ring-[#4F7CFF]"
            />
